...
$string['importedgradeadjusted'] = 'User {$a->name} on item {$a->item} changed from {$a->imported} to {$a->final}';
$string['importedgradesadjusted'] = 'The following grades have been adjusted to fit within the applicable grade ranges: {$a}';
